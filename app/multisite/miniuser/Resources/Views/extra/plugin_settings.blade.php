...
@section('content')
    <div class="bb-form-header">
        <div class="row">
            <div class="col-md-4">
                ...
                {!! Form::text('name','plugin name form',['class' => 'form-name', 'placeholder' => 'Form Name','disabled']) !!}
            </div>
            <div class="col-md-8">
    ...
    <div class="bb-form-header">
        <div class="row">
            <div class="col-md-12">
                <button type="button" class="panel-trigger pull-right add-unit" bb-click="openFieldsWindow">Add fields
                </button>
        ...
        <div class="row" style="display: none">
            <div class="col-sm-8 col-sm-offset-2">
                <h3 class="text-center text-muted">which
                    <a href="https://github.com/formio/ngFormio" target="_blank">Renders as a Form</a> in your
                    Application</h3>
