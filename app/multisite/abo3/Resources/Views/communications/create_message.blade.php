...
@section('content')
   <!-- begin #content -->
   <div class="content-full-width inbox h-100">
      <!-- begin vertical-box -->
            ...
            <div class="vertical-box">
               ...
               <div class="wrapper bg-silver">
                  ...
                  <span class="pull-right">
								<a href="#" class="btn btn-white btn-sm"><i class="fa fa-times f-s-14 m-r-3 m-r-xs-0 t-plus-1"></i> <span class="hidden-xs">Discard</span></a>
							</span>
               </div>
               <!-- end wrapper -->
               <!-- begin vertical-box-row -->
...
@section('css')
   ...
   {{--{!! HTML::style('public/minicms/bootstrap-wysihtml5/bootstrap3-wysihtml5.css') !!}--}}
   <!-- ================== END PAGE CSS STYLE ================== -->
@stop
@section('js')
