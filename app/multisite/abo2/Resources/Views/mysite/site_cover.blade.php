        ...
        <div class="content-pages container-fluid">
            <div class="row">
                <div class="col-md-2 pl-0">
                    <div class="menu">
                        <ul>
                            <li><a href=""><span><i class="fab fa-buromobelexperte"></i></span>General</a>
                            </li>
                            <li class="active"><a href=""><span><i
                                                class="far fa-address-book"></i></span>Data</a></li>
                            <li><a href=""><span><i class="fas fa-quote-left"></i></span>Status</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-10">
