<div class="form-group">
    <div class="col-md-12">
        ...
        {{Form::hidden('user_navbar',0)}}
        <label class="bd_layout pull-left m-r-15">{!! Form::checkbox('user_navbar',1,null,['style' => 'position:initial;z-index:1;']) !!}
            <span class="labls">User Navbar</span>
