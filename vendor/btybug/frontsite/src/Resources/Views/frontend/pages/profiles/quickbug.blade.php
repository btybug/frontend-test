                ...
                <div class="col-md-10">
                    ...
                    <span> <img src="/public/images/girl2.png" alt=""><span
                                style="margin-left: 20px">Rania Davan</span></span>
                                    <div><span style="margin-right: 40px; letter-spacing: 1px"><i
                    ...
                    <i class="far fa-calendar-alt"></i>
                                ...
                                <div class="main-content">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div data-group="hashtag" hidden
                                             class="form-group row align-items-center group-for-tags">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                                        <div class="icons">
                                            <ul class="list-inline">
                                                <li class="list-inline-item"><a href="" class="hashtag"><span
                                                                class="blue-cl-icon"><i
                                                                    class="fas fa-hashtag"></i></span></a></li>
                                                <li class="list-inline-item"><a href="" class="at"><span
                                                                class="red-cl-icon"><i class="fas fa-at"></i></span></a>
                                                </li>
                                                <li class="list-inline-item"><a href="" class="sign"><span
                                                                class="green-cl-icon"><i
                                                                    class="fas fa-lira-sign"></i></span></a></li>
                                                <li class="list-inline-item"><a href="" class="youtube"><span
                                                                class="orange-cl-icon"><i
                                                                    class="fab fa-youtube"></i></span></a></li>
                                                <li class="list-inline-item"><a href="" class="images"><span
                                                                class="purple-cl-icon"><i
                                                                    class="far fa-images"></i></span></a></li>
                                                <li class="list-inline-item"><a href="" class="music"><span
                                                                class="blue-cl-icon"><i class="fas fa-music"></i></span></a>
                                                </li>
                                                <li class="list-inline-item"><a href="" class="star"><span
                                                                class="red-light-cl-icon"><i
                                                                    class="far fa-star"></i></span></a></li>
                                                <li class="list-inline-item"><a href="" class="location"><span
                                                                class="orange-cl-icon"><i
