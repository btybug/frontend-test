        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="right-content">
                        {!! Form::model($social_profile,array('route' => 'front_page_account_profiles_save', 'method' => 'post','id' => 'dataform','files' => true )) !!}
                        <div class="manage-settings row ">
                            <div class="col-xl-6">
                                <div class="settings-left">
                                        ...
                                        <div class="form-group row align-items-center">
                                            {{Form::label('displayEmail', 'Email', array('class' => 'col-sm-3 col-form-label'))}}
                                            <div class="col-sm-8 pl-0">
                                                <div class="input-group">
                                                    {{Form::email('email', $value = null, $attributes = array('class' => 'form-control','id'=>"displayEmail",'aria-label' =>"Text input with dropdown button"))}}
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-8 pl-0">
                                                <div class="input-group">
                                                    {{Form::text('proffesion', $value = null, $attributes = array('class' => 'form-control','id'=>"proffesion",'aria-label' =>"Text input with dropdown button"))}}
                                            ...
                                            <div class="col-sm-6 pl-0">
                                                <div class="input-group flex-nowrap">
                                                    <div class="custom_select">
                                                        {{Form::select('gender',array('F' => 'Female', 'M' => 'Male'), 'M',array('class' => 'form-control'))}}
                                                    </div>
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-6 pl-0">
                                                <div class="input-group flex-nowrap">
                                                    <div class="custom_select">
                                                        {{Form::select('country',array('UK' => 'UK', 'RU' => 'RU','IT' => 'UK'), 'M',array('class' => 'form-control'))}}
                                                    </div>
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-8 pl-0">
                                                <div class="d-flex">
                                                    <div class="col-2 p-0">
                                                        {{Form::text('day', $value = null, $attributes = array('class' => 'form-control','placeholder' => 'DD'))}}
                                                    </div>
                                                    <div class="col-3 p-0">
                                                        <div class="input-group">
                                                        {{Form::text('month', $value = null, $attributes = array('class' => 'form-control','placeholder' => 'MM','aria-label' => 'Text input with dropdown button'))}}
                                                            <div class="input-group-append green-cl">
                                                                <button class="btn btn-outline-secondary dropdown-toggle"
                                                                        type="button" data-toggle="dropdown"
                                                                        aria-haspopup="true"
                                                    ...
                                                    <div class="col-5 p-0">
                                                        <div class="input-group">
                                                            {{Form::text('year', $value = null, $attributes = array('class' => 'form-control','placeholder' => 'YYYY','aria-label' => 'Text input with dropdown button'))}}
                                                            <div class="input-group-append red-cl">
                                                                <button class="btn btn-outline-secondary dropdown-toggle"
                                                                        type="button" data-toggle="dropdown"
                                                                        aria-haspopup="true"
                                        ...
                                        <div class="form-group row align-items-center group-for-tags">
                                            ...
                                            <div class="col-sm-8 pl-0">
                                                <div class="input-group">
                                                    {{Form::text('year', $value = 'Designer', $attributes = array('class' => 'form-control tags_custom','id' => 'displaytags','data-role' => 'tagsinput','aria-label' => 'Text input with dropdown button'))}}
                                                    <div class="input-group-append blue-cl">
                                                        <button class="btn btn-outline-secondary dropdown-toggle"
                                                                type="button" data-toggle="dropdown"
                                                                aria-haspopup="true" aria-expanded="false"><i
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-8 pl-0">
                                                <div class="input-group">
                                                    ...
                                                    {{Form::text('socialMedia[]', $value = null, $attributes = array('class' => 'form-control','id' => 'socialMedia','placeholder' => 'Profile URL','aria-label' => 'Text input with dropdown button'))}}
                                                    <div class="input-group-append blue-cl">
                                                        <button class="btn btn-outline-secondary dropdown-toggle"
                                                                type="button" data-toggle="dropdown"
                                                                aria-haspopup="true" aria-expanded="false"><i
