 ...
 */
class MiniSuperLayouts extends BasePainter implements VariationAccess
{
    use autoinclude;
    /**
     * /**
    ...
    {
        $this->base_path = 'vendor' . DS . 'btybug' . DS . 'mini' . DS . 'src' . DS . 'Resources' . DS . 'Views' . DS . 'ContentLayouts';
        $this->config_path = storage_path('app' . DS . 'minilayout.json');
        parent::__construct();
    }
