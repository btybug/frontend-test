...
//});
    ...
    Route::group(['prefix' => 'application'], function () {
        ...
        Route::get('/edit/{id}', 'ApplicationController@editFormField', true)->name('edit-firld');
        Route::get('/delete/{id}', 'ApplicationController@deleteFormField', true)->name('delete-field');
    });
