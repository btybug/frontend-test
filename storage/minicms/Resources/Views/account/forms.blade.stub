        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                    @if(isset($user_forms) && count($user_forms))
                        @foreach($user_forms as $key => $val)
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a class="pull-right btn btn-danger" href="{{route('mini_account_forms_delete',$val->id)}}" title="Delete Form"><span
                                                class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                    <a class="pull-right btn btn-warning" href="{{route('mini_account_forms_edit',$val->id)}}" title="Edit Form"><span
