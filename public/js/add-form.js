...
<div class="tab-content" data-sortable-id="index-3">
          ...
          <ul class="media-list media-list-with-divider">
              <li class="media media-lg">
                  <a href="javascript:;" class="pull-left">
                      <img class="media-object" src="{!!url('public/minicms/images/gallery-1.jpg')!!}" alt="" />
                  </a>
              ...
              <li class="media media-lg">
                  <a href="javascript:;" class="pull-left">
                      <img class="media-object" src="{!!url('public/minicms/images/gallery-10.jpg')!!}" alt="" />
                  </a>
                  <div class="media-body">
              ...
              <li class="media media-lg">
                  <a href="javascript:;" class="pull-left">
                      <img class="media-object" src="{!!url('public/minicms/images/gallery-7.jpg')!!}" alt="" />
                  </a>
                  <div class="media-body">
              ...
              <li class="media media-lg">
                  <a href="javascript:;" class="pull-left">
                      <img class="media-object" src="{!!url('public/minicms/images/gallery-8.jpg')!!}" alt="" />
                  </a>
                  <div class="media-body">
      ...
      <div class="height-sm" data-scrollbar="true">
          <table class="table">
              ...
              <tr>
                  ...
                  <td class="hidden-sm">
                      <a href="javascript:;">
                          <img src="{!!url('public/minicms/images/product-1.png')!!}" alt=""  />
                      </a>
                  </td>
              ...
              <tr>
                  ...
                  <td class="hidden-sm">
                      <a href="javascript:;">
                          <img src="{!!url('public/minicms/images/product-2.png')!!}" alt="" />
                      </a>
                  </td>
                  <td class="text-nowrap">
                      <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
              ...
              <tr>
                  ...
                  <td class="hidden-sm">
                      <a href="javascript:;">
                          <img src="{!!url('public/minicms/images/product-3.png')!!}" alt="" />
                      </a>
                  </td>
                  <td class="text-nowrap">
                      <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
              ...
              <tr>
                  ...
                  <td class="hidden-tablet hidden-phone">
                      <a href="javascript:;">
                          <img src="{!!url('public/minicms/images/product-5.png')!!}" alt="" />
                      </a>
                  </td>
                  <td class="text-nowrap">
                      <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
      ...
      <div class="height-sm" data-scrollbar="true">
          <ul class="media-list media-list-with-divider">
              <li class="media media-sm">
                  <a href="javascript:;" class="pull-left">
                      <img src="{!!url('public/minicms/images/user-1.jpg')!!}" alt="" class="media-object rounded-corner" />
                  </a>
                  <div class="media-body">
              ...
              <li class="media media-sm">
                  <a href="javascript:;" class="pull-left">
                      <img src="{!!url('public/minicms/images/user-2.jpg')!!}" alt="" class="media-object rounded-corner" />
                  </a>
                  <div class="media-body">
              ...
              <li class="media media-sm">
                  <a href="javascript:;" class="pull-left">
                      <img src="{!!url('public/minicms/images/user-3.jpg')!!}" alt="" class="media-object rounded-corner" />
                  </a>
                  <div class="media-body">
              ...
              <li class="media media-sm">
                  <a href="javascript:;" class="pull-left">
                      <img src="{!!url('public/minicms/images/user-4.jpg')!!}" alt="" class="media-object rounded-corner" />
                  </a>
                  <div class="media-body">
  ...
  <div class="panel-body">
      <div class="height-sm" data-scrollbar="true">
          <ul class="media-list media-list-with-divider media-messaging">
              <li class="media media-sm">
                  <a href="javascript:;" class="pull-left">
                      <img src="{!!url('public/minicms/images/user-5.jpg')!!}" alt="" class="media-object rounded-corner" />
                  </a>
                  <div class="media-body">
              ...
              <li class="media media-sm">
                  <a href="javascript:;" class="pull-left">
                      <img src="{!!url('public/minicms/images/user-6.jpg')!!}" alt="" class="media-object rounded-corner" />
                  </a>
                  <div class="media-body">
              ...
              <li class="media media-sm">
                  <a href="javascript:;" class="pull-left">
                      <img src="{!!url('public/minicms/images/user-8.jpg')!!}" alt="" class="media-object rounded-corner" />
                  </a>
                  <div class="media-body">
              ...
              <li class="media media-sm">
                  <a href="javascript:;" class="pull-left">
                      <img src="{!!url('public/minicms/images/user-7.jpg')!!}" alt="" class="media-object rounded-corner" />
                  </a>
                  <div class="media-body">
                      <h5 class="media-heading">John Doe</h5>
  ...
  var elemnts = units.map(
    (item, index) =>
      `<li class="item draggable item-container">${item.name}</li>`
  );
  ...
  $(".add-unit-btn").click(function() {
    if (
      $(this).css("margin-right") == slider_width - 100 + "px" &&
      !$(this).is(":animated")
    ) {
      $(".add-unit-btn").animate({
        "margin-right": "-=" + (slider_width - 100)
      });
